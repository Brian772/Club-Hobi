    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'canvas.composer' => \Illuminate\Support\Composer::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Project\Club_Hobi\public\storage' => 'string',
            ...
            'services.guzzle.verify' => 'boolean',
            ...
            'turbo-laravel.queue' => 'boolean',
            'turbo-laravel.models_namespace' => 'array',
            'turbo-laravel.automatically_register_middleware' => 'boolean',
            'turbo-laravel.features' => 'array',
            'turbo-laravel.redirect_guessing_exceptions' => 'array',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\Project\\Club_Hobi\\public\\storage','logging.default','logging.deprecations.channel',
...
'services.google.client_id','services.google.client_secret','services.google.redirect','services.guzzle.verify','session.driver',
...
'debugbar.collectors.inertia','debugbar.collectors.jobs','debugbar.collectors.pennant','debugbar.collectors.ai','debugbar.collectors.http_client',
...
'debugbar.options.db.backtrace_exclude_paths','debugbar.options.db.backtrace_editor_links','debugbar.options.db.timeline','debugbar.options.db.duration_background','debugbar.options.db.explain',
...
'debugbar.options.http_client.timeline','debugbar.options.ai.values','debugbar.custom_collectors','debugbar.editor','debugbar.capture_ajax',
...
'debugbar.debug_backtrace_limit','turbo-laravel.queue','turbo-laravel.models_namespace','turbo-laravel.automatically_register_middleware','turbo-laravel.features',
'turbo-laravel.redirect_guessing_exceptions','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'turbo_recede_historical_location','turbo_resume_historical_location','turbo_refresh_historical_location','home',
'dashboard','profile.dashboard','posts.dashboard','club_files.dashboard','notifications.index',
'notifications.read','messages.index','messages.show','messages.store','clubs.index',
'clubs.show','clubs.join','clubs.leave','posts.create','posts.store',
'posts.show','posts.like','posts.comments.store','logout','settings.index',
'settings.profile','settings.profile.update','settings.profile.avatar','settings.profile.avatar.delete','settings.profile.hobby.add',
'settings.profile.hobby.delete','settings.account','appeals.create','appeals.store','profile.index',
'profile.edit','profile.update','profile.destroy','admin.clubs.kick','admin.clubs.edit',
'admin.clubs.update','register','register.step1','register.step2','register.step3',
'login','login.authenticate','social.redirect','social.callback','password.request',
...
'admin.clubs.edit','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','clubs.index','clubs.show','components.alert',
...
'components.hero-desktop','components.hero-mobile','components.input-error','components.input-label','components.modal',
'components.nav-link','components.navbar-sidebar','components.post','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','content&dokuments.content','content&dokuments.index','dashboard',
'landing','layouts.app','layouts.guest','layouts.navigation','layouts.partials.icons.bell',
'layouts.partials.icons.chat','layouts.partials.icons.cog','layouts.partials.icons.folder','layouts.partials.icons.grid','layouts.partials.notification-panel',
'layouts.partials.sidebar-content','layouts.partials.topbar','messages.index','notifications.index','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','settings.accountsettings','settings.profilesettings',
'settings.setting','welcome','e2349d7eca4236282d99fd8197c11a46::exempts-page-from-cache','e2349d7eca4236282d99fd8197c11a46::exempts-page-from-preview','e2349d7eca4236282d99fd8197c11a46::frame',
'e2349d7eca4236282d99fd8197c11a46::page-requires-reload','e2349d7eca4236282d99fd8197c11a46::page-view-transition','e2349d7eca4236282d99fd8197c11a46::refresh-method','e2349d7eca4236282d99fd8197c11a46::refresh-scroll','e2349d7eca4236282d99fd8197c11a46::refreshes-with',
'e2349d7eca4236282d99fd8197c11a46::stream','e2349d7eca4236282d99fd8197c11a46::stream-from','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','turbo-laravel::components.exempts-page-from-cache','turbo-laravel::components.exempts-page-from-preview',
'turbo-laravel::components.frame','turbo-laravel::components.page-requires-reload','turbo-laravel::components.page-view-transition','turbo-laravel::components.refresh-method','turbo-laravel::components.refresh-scroll',
'turbo-laravel::components.refreshes-with','turbo-laravel::components.stream','turbo-laravel::components.stream-from','turbo-laravel::turbo-stream',);
        registerArgumentsSet('translations', 
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array_keys','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.base64','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url',
'D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.Project.Club_Hobi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
