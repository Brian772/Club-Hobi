...
<div class="post-page">
    ...
    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" id="postForm">
        ...
        <div class="form-group">
            ...
            <input type="file" id="mediaInput" accept="image/*,video/*,audio/*,.pdf,.doc,.docx" multiple class="hidden" onchange="addFiles(this.files)">
...
<script>
    ...
    function renderPreviews() {
        ...
        selectedFiles.forEach((file, index) => {
            ...
            wrapper.className = 'relative w-24 h-24 shrink-0 rounded-xl overflow-hidden border border-neutral-200 bg-neutral-100 group';
