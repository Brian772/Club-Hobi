...
<div class="mobile-screen dashboard-mobile">
    <aside class="mobile-sidebar open" id="mobileSidebar">
        <button type="button" class="sidebar-close" onclick="history.back()">
            <i class="bi bi-x"></i>
        </button>

        <nav class="sidebar-nav">
            <a href="{{ route('mobile.dashboard') }}" class="sidebar-link active">
    ...
    <div class="mobile-sidebar-overlay show"></div>

    <header class="top-bar dashboard-topbar">
        <button type="button" class="icon-btn menu-trigger" onclick="history.back()">
